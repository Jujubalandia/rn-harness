...
Write-Host "   - firecrawl-search, firecrawl-scrape  (firecrawl MCP -- D1-D2)"
Write-Host "   - design-token-guardian, i18n-validator  (D3+)"
Write-Host "   - expo-debugger, auth-assessment, secure-storage-audit, supabase-migrator  (D4+)"
Write-Host "   - code-review  (pre-commit)"
Write-Host "   - qa-tester, store-metadata-reviewer  (D13-D15)"
Write-Host "   - marketing-copywriter, viral-content-strategist  (D17-D18)"
Write-Host "   - privacy-audit  (pos-D20)"
Write-Host ""
